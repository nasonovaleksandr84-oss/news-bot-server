...
ВРЕМЕННОЕ ОКНО ПОИСКА: Ищи материал не старше 48 часов. Всегда включай дату в поисковый запрос. Если у материала нет явной даты публикации — пропускай его.
...
ЗАДАЧА:
1. Через web search найди материал не старше 48 часов по теме геймификации, лояльности или поведенческой экономики в бизнесе. ОБЯЗАТЕЛЬНО добавляй в поисковый запрос текущий год и месяц (${new Date().toLocaleString('ru-RU', {month: 'long', year: 'numeric'})}) чтобы поиск возвращал свежие результаты. Проверяй дату публикации у каждого найденного материала.
